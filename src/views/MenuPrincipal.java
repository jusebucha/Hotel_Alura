...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Sebastian Bustamante © 2023");
		lblCopyR.setBounds(207, 11, 392, 19);
		...
		btnLogin.setBounds(748, 249, 103, 94);
		...
		imagenLogin.setBounds(10, 0, 81, 98);
		...
		// Boton para salir de la aplicación
				...
				btnSalir.setBounds(866, 462, 44, 39);
				panel.add(btnSalir);
